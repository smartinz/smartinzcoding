...
{
	public class EmployeeStringConverter : SpikeRhinoSecurity.Infrastructure.IStringConverter<SpikeRhinoSecurity.Domain.Employee>
	{
		const char KeySeparator = '\\';
		private readonly SpikeRhinoSecurity.Data.EmployeeRepository _repository;

		public EmployeeStringConverter(SpikeRhinoSecurity.Data.EmployeeRepository repository)
		{
			_repository = repository;
		}

		public string ToString(SpikeRhinoSecurity.Domain.Employee obj)
		{
			return obj.EmployeeId.ToString();
		}

		public SpikeRhinoSecurity.Domain.Employee FromString(string str)
		{
