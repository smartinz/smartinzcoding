...
{
	public class TerritoryStringConverter : SpikeRhinoSecurity.Infrastructure.IStringConverter<SpikeRhinoSecurity.Domain.Territory>
	{
		const char KeySeparator = '\\';
		private readonly SpikeRhinoSecurity.Data.TerritoryRepository _repository;

		public TerritoryStringConverter(SpikeRhinoSecurity.Data.TerritoryRepository repository)
		{
			_repository = repository;
		}

		public string ToString(SpikeRhinoSecurity.Domain.Territory obj)
		{
			return obj.TerritoryId.ToString();
		}

		public SpikeRhinoSecurity.Domain.Territory FromString(string str)
		{
