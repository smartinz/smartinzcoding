...
{
	public class CategoryStringConverter : SpikeRhinoSecurity.Infrastructure.IStringConverter<SpikeRhinoSecurity.Domain.Category>
	{
		const char KeySeparator = '\\';
		private readonly SpikeRhinoSecurity.Data.CategoryRepository _repository;

		public CategoryStringConverter(SpikeRhinoSecurity.Data.CategoryRepository repository)
		{
			_repository = repository;
		}

		public string ToString(SpikeRhinoSecurity.Domain.Category obj)
		{
			return obj.CategoryId.ToString();
		}

		public SpikeRhinoSecurity.Domain.Category FromString(string str)
		{
