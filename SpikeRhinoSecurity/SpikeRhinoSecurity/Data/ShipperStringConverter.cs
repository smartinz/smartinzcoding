...
{
	public class ShipperStringConverter : SpikeRhinoSecurity.Infrastructure.IStringConverter<SpikeRhinoSecurity.Domain.Shipper>
	{
		const char KeySeparator = '\\';
		private readonly SpikeRhinoSecurity.Data.ShipperRepository _repository;

		public ShipperStringConverter(SpikeRhinoSecurity.Data.ShipperRepository repository)
		{
			_repository = repository;
		}

		public string ToString(SpikeRhinoSecurity.Domain.Shipper obj)
		{
			return obj.ShipperId.ToString();
		}

		public SpikeRhinoSecurity.Domain.Shipper FromString(string str)
		{
