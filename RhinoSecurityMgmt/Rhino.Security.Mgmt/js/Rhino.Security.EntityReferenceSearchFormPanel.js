...
Rhino.Security.EntityReferenceSearchFormPanel = Ext.extend(Ext.form.FormPanel, {
	labelWidth: 100,
	border: false,
	padding: 10,
	initComponent: function () {
		...
		Rhino.Security.EntityReferenceSearchFormPanel.superclass.initComponent.apply(this, arguments);
	}
});