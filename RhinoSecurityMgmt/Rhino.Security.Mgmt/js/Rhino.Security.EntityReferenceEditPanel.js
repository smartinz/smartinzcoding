...
Rhino.Security.EntityReferenceEditPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		var _this = this,
		_formPanel = new Rhino.Security.EntityReferenceFormPanel(),
		_saveItemButtonHandler = function () {
			_this.el.mask('Saving...', 'x-mask-loading');
			Rpc.call({
				url: 'EntityReference/Save',
		...
		Rhino.Security.EntityReferenceEditPanel.superclass.initComponent.apply(_this, arguments);
	}
});