...
Rhino.Security.EntitiesGroupEditPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		var _this = this,
		_formPanel = new Rhino.Security.EntitiesGroupFormPanel(),
		_saveItemButtonHandler = function () {
			_this.el.mask('Saving...', 'x-mask-loading');
			Rpc.call({
				url: 'EntitiesGroup/Save',
		...
		Rhino.Security.EntitiesGroupEditPanel.superclass.initComponent.apply(_this, arguments);
	}
});