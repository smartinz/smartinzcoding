...
Rhino.Security.EntityTypePickerWindow = Ext.extend(Ext.Window, {
	initComponent: function () {
		...
		_searchFormPanel = new Rhino.Security.EntityTypeSearchFormPanel({
		...
		_gridPanel = new Rhino.Security.EntityTypeGridPanel({
			region: 'center',
			store: _store,
			bbar: _pagingToolbar,
			listeners: {
		...
		Rhino.Security.EntityTypePickerWindow.superclass.initComponent.apply(_this, arguments);
