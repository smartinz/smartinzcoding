...
Rhino.Security.PermissionEditPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		var _this = this,
		_formPanel = new Rhino.Security.PermissionFormPanel(),
		...
		Rhino.Security.PermissionEditPanel.superclass.initComponent.apply(_this, arguments);
	}
});