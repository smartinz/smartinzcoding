...
{
	public class EntityReferenceStringConverter : Nexida.Infrastructure.IStringConverter<Rhino.Security.Model.EntityReference>
	{
		const char KeySeparator = '\\';
		private readonly Rhino.Security.Data.EntityReferenceRepository _repository;

		public EntityReferenceStringConverter(Rhino.Security.Data.EntityReferenceRepository repository)
		{
