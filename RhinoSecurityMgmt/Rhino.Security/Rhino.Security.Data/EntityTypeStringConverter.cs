...
namespace Rhino.Security.Data
{
	public class EntityTypeStringConverter : Nexida.Infrastructure.IStringConverter<Rhino.Security.Model.EntityType>
	{
		...
		public EntityTypeStringConverter(Rhino.Security.Data.EntityTypeRepository repository)
		{
			_repository = repository;
		}

		public string ToString(Rhino.Security.Model.EntityType obj)
		{
			return obj.Id.ToString();
		}

		public Rhino.Security.Model.EntityType FromString(string str)
		{
