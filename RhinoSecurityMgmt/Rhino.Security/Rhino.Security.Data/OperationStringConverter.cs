...
{
	public class OperationStringConverter : Nexida.Infrastructure.IStringConverter<Rhino.Security.Model.Operation>
	{
		const char KeySeparator = '\\';
		private readonly Rhino.Security.Data.OperationRepository _repository;

		public OperationStringConverter(Rhino.Security.Data.OperationRepository repository)
		{
