...
Rhino.Security.EntityTypeSearchFormPanel = Ext.extend(Ext.form.FormPanel, {
	labelWidth: 100,
	border: false,
	padding: 10,
	initComponent: function () {
		...
		Rhino.Security.EntityTypeSearchFormPanel.superclass.initComponent.apply(this, arguments);
	}
});