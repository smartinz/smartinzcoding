...
Rhino.Security.EntityReferencePickerWindow = Ext.extend(Ext.Window, {
	initComponent: function () {
		...
		_searchFormPanel = new Rhino.Security.EntityReferenceSearchFormPanel({
		...
		_gridPanel = new Rhino.Security.EntityReferenceGridPanel({
			region: 'center',
			store: _store,
			bbar: _pagingToolbar,
			listeners: {
		...
		Rhino.Security.EntityReferencePickerWindow.superclass.initComponent.apply(_this, arguments);
