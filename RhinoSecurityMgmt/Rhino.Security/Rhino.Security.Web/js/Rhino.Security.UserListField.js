...
Rhino.Security.UserListField = Ext.extend(Ext.form.Field, {
	initComponent: function () {
		...
		this.gridPanel = new Rhino.Security.UserGridPanel(cfg);
		Rhino.Security.UserListField.superclass.initComponent.apply(this, arguments);
	},
	...
	onRender: function (ct, position) {
		...
		Rhino.Security.UserListField.superclass.onRender.call(this, ct, position);
	...
	onResize: function (w, h, aw, ah) {
		Rhino.Security.UserListField.superclass.onResize.apply(this, arguments);
		this.gridPanel.setSize(w, h);
	},

	onEnable: function () {
		Rhino.Security.UserListField.superclass.onEnable.apply(this, arguments);
		this.gridPanel.enable();
	},

	onDisable: function () {
		Rhino.Security.UserListField.superclass.onDisable.apply(this, arguments);
		this.gridPanel.disable();
	},

	beforeDestroy: function () {
		Ext.destroy(this.gridPanel);
		Rhino.Security.UserListField.superclass.beforeDestroy.apply(this, arguments);
	},

	setValue: function (v) {
		this.gridPanel.getStore().proxy.data.items = v;
		this.gridPanel.getStore().load();
		return Rhino.Security.UserListField.superclass.setValue.apply(this, arguments);
	},
