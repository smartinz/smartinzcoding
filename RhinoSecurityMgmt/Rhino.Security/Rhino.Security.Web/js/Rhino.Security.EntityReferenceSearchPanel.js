...
Rhino.Security.EntityReferenceSearchPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		...
		Rhino.Security.EntityReferenceSearchPanel.superclass.initComponent.apply(_this, arguments);
