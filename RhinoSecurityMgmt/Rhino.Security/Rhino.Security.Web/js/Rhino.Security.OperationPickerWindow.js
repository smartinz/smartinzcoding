...
Rhino.Security.OperationPickerWindow = Ext.extend(Ext.Window, {
	initComponent: function () {
		...
		Rhino.Security.OperationPickerWindow.superclass.initComponent.apply(_this, arguments);
